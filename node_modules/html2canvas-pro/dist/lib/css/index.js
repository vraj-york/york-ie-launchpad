...
class CSSParsedDeclaration {
    constructor(context, declaration) {
        ...
        this.textDecorationStyle = parse(context, text_decoration_style_1.textDecorationStyle, declaration.textDecorationStyle);
        this.textDecorationThickness = parse(context, text_decoration_thickness_1.textDecorationThickness, declaration.textDecorationThickness);
        this.textUnderlineOffset = parse(context, text_underline_offset_1.textUnderlineOffset, declaration.textUnderlineOffset);
        ...
        this.textOverflow = parse(context, text_overflow_1.textOverflow, declaration.textOverflow);
        ...
        this.webkitLineClamp = parse(context, webkit_line_clamp_1.webkitLineClamp, declaration.webkitLineClamp);

...
function ComboboxInput({
	...
	return (
		<InputGroup
			className={cn(
				"w-auto",
				"has-[[data-slot=input-group-control]:disabled]:bg-card has-[[data-slot=input-group-control]:disabled]:cursor-not-allowed",
				"has-[[data-slot=input-group-control]:disabled]:[&_[data-slot=input-group-control]]:text-muted-foreground has-[[data-slot=input-group-control]:disabled]:[&_[data-slot=input-group-control]]:opacity-100",
				className,
			)}
		>
